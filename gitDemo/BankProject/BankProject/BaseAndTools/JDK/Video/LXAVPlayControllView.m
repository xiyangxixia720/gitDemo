...
-(UILabel *)titleLabel{
    if (!_titleLabel) {
        _titleLabel =[UILabel LXLabelWithTextNoFrame:@"蝙蝠侠大战大灰狼" textColor:[UIColor colorWithHexString:@"ffffff"] backgroundColor:[UIColor clearColor] font:Font(15) textAlignment:NSTextAlignmentCenter];
    }
    return _titleLabel;
}
...
-(UILabel *)startLabel{
    if (!_startLabel) {
        _startLabel =[UILabel LXLabelWithTextNoFrame:@"00:00" textColor:[UIColor colorWithHexString:@"ffffff"] backgroundColor:self.bottomView.backgroundColor font:Font(13) textAlignment:NSTextAlignmentCenter];
...
-(UILabel *)endLabel{
    if (!_endLabel) {
        _endLabel =[UILabel LXLabelWithTextNoFrame:@"00:00" textColor:[UIColor colorWithHexString:@"ffffff"] backgroundColor:self.bottomView.backgroundColor font:Font(13) textAlignment:NSTextAlignmentCenter];
    }
    return _endLabel;
}

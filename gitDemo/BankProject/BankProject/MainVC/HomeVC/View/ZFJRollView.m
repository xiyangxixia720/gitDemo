...
- (void)rollView:(NSArray *)dataArr
{
    ...
    for (int i = 0; i < self.rollDataArr.count + 2; i++) {
        ...
        //设置图片
        if (i == 0) {
            [picImageView sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@", self.rollDataArr[self.rollDataArr.count - 1]]] placeholderImage:[UIImage imageNamed:@"img222"]];
        }else if (i == self.rollDataArr.count+1) {
            [picImageView sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@", self.rollDataArr[0]]] placeholderImage:[UIImage imageNamed:@"img222"]];
        }else {
            [picImageView sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@", self.rollDataArr[i - 1]]] placeholderImage:[UIImage imageNamed:@"img222"]];
        }
